...
const CacheMapping = {
  theme: {
    jsonpath: '../../components/skeleton/dependencies/themes.json',
    csspath: '../../components/skeleton/dependencies/style/themes.css'
  },
  animation: {
...
export async function ValidateSkeleton(animation, theme, callback, instance) {
